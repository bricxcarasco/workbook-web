<nav class="mx-auto site-navigation">
    <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
        ...
        <li class="d-lg-none"><a style="color: blue;" href="{{ url('/provider') }}"><img src="{{ asset('images') }}/{{ $profile->image }}" style="width: 50px; height:50px;" class="img-circle elevation-2" alt="User Image"></a></li>
