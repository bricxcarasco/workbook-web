...
<header class="site-navbar mt-3">
    <div class="container-fluid">
        ...
        @include('provider.parts.sidebar')
        
        <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
            <div class="ml-auto">
            <a href="{{ url('/provider/post-job') }}" class="btn btn-outline-white border-width-2 d-none d-lg-inline-block"><span class="mr-2 icon-add"></span>Post a Job</a>
