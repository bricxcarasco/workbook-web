...
<div class="site-wrap">
    ...
    <section class="site-section">
      <div class="container">
        ...
        <form class="p-4 p-md-5 border rounded" action="/provider/post-job" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row mb-5">
            <div class="col-lg-12">
                ...
                <h3 class="text-black mb-5 border-bottom pb-2">Job Details</h3>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" id="event_time" name="event_time" value="{{ old('event_time') }}" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="details">{{ old('details') }}</textarea>
                ...
                <div class="row form-group">
                  <div class="col-md-6 mb-3 mb-md-0">
                      ...
                      <input type="text" id="min_offer" name="min_offer" value="{{ old('min_offer') }}" class="form-control" placeholder="Salary offer range">
                  ...
                  <div class="col-md-6">
                      ...
                      <input type="text" id="max_offer" name="max_offer" value="{{ old('max_offer') }}" class="form-control" placeholder="Salary offer range">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="municipality" value="{{ old('municipality') }}" name="municipality" placeholder="e.g. Sta Cruz">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="barangay" value="{{ old('barangay') }}" name="barangay" placeholder="e.g. Brgy. Santisima">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="postal" value="{{ old('postal') }}" name="postal" placeholder="e.g. 4009">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="slots" value="{{ old('slots') }}" name="slots" placeholder="Slots available">
                  @if ($errors->has('slots'))
                ...
                <div class="form-group">
                  ...
                  {{-- <label class="btn btn-primary btn-md btn-file"> --}}
                    <input class="btn btn-primary btn-md btn-file" type="file" value="{{ old('dti') }}" id="dti" name="dti">
                  {{-- </label> --}}
                  @if ($errors->has('dti'))
