...
<header class="site-navbar mt-3">
    <div class="container-fluid">
        ...
        <div class="site-logo col-6"><a href="{{ url('/seeker') }}"><img align="middle" style="width: 50px; height: 50px; float: left;" src="{{ asset('images/workbook.png') }}" alt="Workbook"> WorkBook</a></div>
